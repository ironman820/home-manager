...
in {
  ...
  config = mkIf cfg.enable {
    ...
    home = {
      file = {
        ".config/nvim/lua".source = mkOutOfStoreSymlink "${config.home.homeDirectory}/.config/home-manager/modules/home/nvim/config/lua";
        ".config/nvim/lazy-lock.json".source = mkOutOfStoreSymlink "${config.home.homeDirectory}/.config/home-manager/modules/home/nvim/config/lazy-lock.json";
      };
      packages = with pkgs; [
        cargo
        python3
